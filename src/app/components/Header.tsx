      ...
      <div className="px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-2">
            <a
              href="https://www.figma.com/community/file/1589401107488251698/trinil-icons-1000-professional-open-source-icons"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm px-3 py-2 rounded-md border border-input bg-background hover:border-ring hover:bg-muted/50 transition-colors"
            >
